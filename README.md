...
| [luci-app-podman](https://github.com/Zerogiven-OpenWRT-Packages/luci-app-podman) | Modern web interface for managing Podman containers with auto-update, auto-st... | 2.0.1-r1 | 24.10 | all |
